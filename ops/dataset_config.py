...
# "/data/Disk_A/zhongwei/dataset/somethin-something-v1/"
# ROOT_DATASET = '/data/Disk_A/wucong/SZW_TempUsage/dataset/'

def return_ucf101(modality):
    filename_categories = 'UCF101/labels/classInd.txt'
    if modality == 'RGB':
        root_data = 'D:\\_Datasets\\UCF-101_IMAGES'
        # root_data = 'D:\\_DataSources\\UCF-101_IMAGES'
...
def return_something(modality):
    ...
    if modality == 'RGB':
        ...
        root_data = 'D:\\_Datasets\\ssv1\\20bn-something-something-v1\\20bn-something-something-v1'
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        # root_data = '/data/Disk_C/something/20bn-something-something-v2-frames'
        root_data = '/home/action_data/somthing/v2/20bn-something-something-v2-frames'
