...
class TDN_Net(nn.Module):
    ...
    def __init__(self, resnet_model, resnet_model1, apha, belta):
        ...
        self.conv1_5 = nn.Sequential(nn.Conv2d(6,64,kernel_size=7,stride=2,padding=3,bias=False),nn.BatchNorm2d(64),nn.ReLU(inplace=True))
    ...
    def forward(self, x):
        ...
        # else:
        #     resolu = (56, 56)
        # temp_out_diff1 = F.interpolate(temp_out_diff1, resolu)
